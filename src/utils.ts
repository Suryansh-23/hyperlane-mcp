import { ensure0x, promiseObjAll, objMap } from "@hyperlane-xyz/utils";
import { ethers } from "ethers";
import { IRegistry , GithubRegistry, ChainAddresses } from "@hyperlane-xyz/registry"
import { HookConfig , IsmConfig , HookType , IsmType , ChainName , ChainMap , ChainMetadata , MultiProvider , HyperlaneCore, AgentConfig, AgentConfigSchema  } from "@hyperlane-xyz/sdk";
...
export async   function confirmExistingMailbox( chain : ChainName ) { 
